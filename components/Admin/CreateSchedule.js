    ...
    return (
      <View style={styles.container}>
        ...
        <View>
          ...
          containerStyle={{borderWidth:1, borderColor:'lightgrey', borderRadius:5, width:Width*0.8,height:50, paddingRight:10,marginBottom:20}}
          rippleCentered={true}
          inputContainerStyle={{ borderBottomColor: 'transparent' }}
          data={guardNames}
          valueExtractor={({value})=> value}
          onChangeText={(value)=>{this.setState({selectedGuardName:value})}}
          />
        </View> 
        <View>
          ...
          data={siteNames}
          valueExtractor={({value})=> value}
          onChangeText={(value)=>{this.setState({selectedSiteName:value})}}
          />
        </View> 
        <View>
          ...
          data={shiftTime}
          valueExtractor={({value})=> value}
          onChangeText={(value)=>{this.setState({selectedShiftTiming:value})}}
          />
        </View> 
        <DateTimePickerModal
